...
namespace ESC_POS_USB_NET.EpsonCommands
{
    ...
    {
        public byte[] Code128(string code,Positions printString=Positions.NotPrint, BarCodeCharSubset codeSubset = BarCodeCharSubset.C)
        {
            return new byte[] { 29, 119, 2 } // Width
                ...
                .AddBytes(new[] { '{'.ToByte(), codeSubset.ToByte() })
                .AddBytes(code)
                .AddLF();
        }
